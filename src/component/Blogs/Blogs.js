...
const Blogs = () => {
    return (
        <>
            <div>
                <h1 className="text-center text-info m-4">Blogs</h1>
            </div>
            <div className="blogs-section">
                ...
                <div class="blog-card">
                    ...
                    <h1 className="blog-title">Health Insurance - One Less Thing to Worry About - Peoplecare
                        .</h1>
                    <p class="blog-overview">Find Out Why 96% of Our Members Love Being Part Of Our Family - Join today! The Other 4% Just Need a Hug. Tick Feel-Good Health Cover Off Your List Today. Supporting Communities.</p>
                </div>
                <div class="blog-card">
